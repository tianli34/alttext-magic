...
import { dedupeScopeFlags, isScopeFlag, normalizeScopeFlags, parseScopeFlags, safeParseScopeFlags, sortScopeFlags, } from "../app/lib/scope-utils";
function run() {
    ...
    assert.deepEqual(parseScopeFlags([
        "ARTICLE_IMAGE",
        "FILES",
        "PRODUCT_MEDIA",
        "FILES",
