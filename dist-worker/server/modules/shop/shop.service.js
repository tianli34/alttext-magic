...
import { DEFAULT_SCAN_SCOPE_FLAGS, encodeScanScopeFlags, } from "./scope.service";
...
export async function persistOfflineShopSession({ session, }) {
    ...
    logger.info({ shop: session.shop, sessionId: session.id }, "Persisted shop installation and encrypted offline token");
}
