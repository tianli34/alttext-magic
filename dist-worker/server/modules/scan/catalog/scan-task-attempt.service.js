...
export async function reserveNextScanTaskAttempt(scanTaskId) {
...
export async function markAttemptFinishedFromWebhook(input) {
    ...
    const attemptStatus = input.bulkOperationStatus === "COMPLETED" ? "READY_TO_PARSE" : "FAILED";
    const taskStatus = input.bulkOperationStatus === "COMPLETED" ? "RUNNING" : "FAILED";
